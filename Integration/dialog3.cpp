...
void Dialog3::on_fr_ajouter_clicked()
{
...
QMessageBox::information(this, QObject::tr("Ajouter un fournisseurs"),
     ...
     {incorrect->play();
      ...
      QMessageBox::critical(this, QObject::tr("Ajouter un fournisseurs"),
                  QObject::tr("Erreur !.\n"
                              "Click Cancel to exit."), QMessageBox::Cancel);}
...
void Dialog3::on_fr_modifier_clicked()
{
    int idf2=ui->le_idf->text().toInt();
       ...
       fournisseurs f1;
             ...
             bool test = f1.modifier(idf2,tel,nom,prenom,email,adresse);
                if(test){correct->play();
                    ui->tabfournisseurs->setModel(tmpfournisseurs.afficher());
                    QMessageBox::information(this, QObject::tr("Modifier un fournisseurs"),
                                QObject::tr(" fournisseurs modifier.\n"
                                            "Click Cancel to exit."), QMessageBox::Cancel);
                }
                else
                   {incorrect->play();
                    QMessageBox::critical(this, QObject::tr("Modifier un fournisseurs"),
                                QObject::tr("Erreur !.\n"
                                            "Click Cancel to exit."), QMessageBox::Cancel);}
...
void Dialog3::on_fr_supprimer_clicked()
{
    int idf=ui->le_idf_2->text().toInt();
    bool test=tmpfournisseurs.supprimer(idf);
    if(test)
    {ui->tabfournisseurs->setModel(tmpfournisseurs.afficher());//refresh
        QMessageBox::information(this, QObject::tr("Supprimer un fournisseurs"),
    ...
    bool test=true;
        if(test){
               ...
               { ui->tabfournisseurs->setModel(tmpfournisseurs.trier_idf());
                ...
                QMessageBox::critical(this, QObject::tr("trier fournisseurs"),
                            QObject::tr("Erreur !.\n"
                                        "Click Cancel to exit."), QMessageBox::Cancel);
...
void Dialog3::on_pb_ajouter_p_clicked()
{
...
QMessageBox::information(this, QObject::tr("Ajouter une equipements"),
                  QObject::tr("equipements ajoutée.\n"
                              "Click Cancel to exit."), QMessageBox::Cancel);

}
  else
      QMessageBox::critical(this, QObject::tr("Ajouter une equipements"),
                  QObject::tr("Erreur !.\n"
                              "Click Cancel to exit."), QMessageBox::Cancel);
}

void Dialog3::on_pb_modifier_p_clicked()
{
    ...
    QDate date_delivration= ui->le_date->date();
        ...
        equipements eq;
            ...
            if(eq.rech(code2)){
                ...
                if(test){
                    ui->tabequipements->setModel(tmpequipements.afficher_equipements());
                    QMessageBox::information(this, QObject::tr("Modifier une equipements"),
...
void Dialog3::on_pb_supprimer_p_clicked()
{
    int idf=ui->le_idf_2->text().toInt();
    bool test=tmpfournisseurs.supprimer(idf);
    if(test)
...
void Dialog3::on_sendBtn_2_clicked()
{
...
void Dialog3::on_Imprimer_clicked()
{
...
void Dialog3::on_tabfournisseurs_activated(const QModelIndex &index)
{
...
void Dialog3::on_tabequipements_activated(const QModelIndex &index)
{
...
void Dialog3::on_retour1_clicked()
{
     hide();
}

void Dialog3::on_retour1_2_clicked()
{
     hide();
}

void Dialog3::on_retour1_3_clicked()
{
    hide();
}
